    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signUpButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(option1.isChecked()) p1 = "" + 1;
                else p1 = "" + 0;
                if(option2.isChecked()) p2 = "" + 1;
                else p2 = "" + 0;
                if(option3.isChecked()) p3 = "" + 1;
                else p3 = "" + 0;
                if(option4.isChecked()) p4 = "" + 1;
                else p4 = "" + 0;

                Log.e("option1234","= "+ p1 +  " " + p2 + " " + p3 + " " + p4);

                // request authentication with remote server4
                AsyncDataClass asyncRequestObject = new AsyncDataClass();
                asyncRequestObject.execute(serverUrl, enteredUseremail, enteredPassword, enteredUsername, p1, p2, p3, p4);
            }
        });
    }
    @Override
    ...
    private class AsyncDataClass extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                nameValuePairs.add(new BasicNameValuePair("p1",Integer.toString(1)));
                nameValuePairs.add(new BasicNameValuePair("p2",params[5]));
                nameValuePairs.add(new BasicNameValuePair("p3",params[6]));
                nameValuePairs.add(new BasicNameValuePair("p4",params[7]));
